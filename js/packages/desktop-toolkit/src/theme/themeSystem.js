...
export const TOOLKIT_FONT_STYLE_MODES = [
  ...
  },
  {
    id: 'blueprint',
    label: 'Blueprint',
    description: 'Stamped not typeset. Tight tracking, heavy mono, minimal leading.',
    weight: { display: 500, ui: 400, mono: 600 },
    leading: { display: 1.15, ui: 1.35, mono: 1.3 },
    tracking: { display: '-0.01em', ui: '0em', mono: '-0.01em' },
  },
  {
    id: 'dense',
    label: 'Dense',
    description: 'Dashboard/data mode. Minimum leading, condensed weight, zero tracking.',
    weight: { display: 500, ui: 500, mono: 500 },
    leading: { display: 1.1, ui: 1.15, mono: 1.1 },
    tracking: { display: '0em', ui: '0em', mono: '0em' },
  },
  {
    id: 'typewriter',
    label: 'Typewriter',
    description: 'Mono-forward rhythm. All leading inflated to match mono cadence.',
    weight: { display: 400, ui: 300, mono: 400 },
    leading: { display: 1.6, ui: 1.65, mono: 1.6 },
    tracking: { display: '0.01em', ui: '0.01em', mono: '0em' },
  },
  {
    id: 'petal',
    label: 'Petal',
    description: 'Featherlight, maximum air. Perfume-brand softness.',
    weight: { display: 300, ui: 300, mono: 300 },
    leading: { display: 1.45, ui: 1.7, mono: 1.6 },
    tracking: { display: '0.04em', ui: '0.025em', mono: '0.01em' },
  },
  {
    id: 'vanity',
    label: 'Vanity',
    description: 'Magazine-masthead contrast. Heavy headline, ultralight body.',
    weight: { display: 600, ui: 300, mono: 400 },
    leading: { display: 1.1, ui: 1.75, mono: 1.5 },
    tracking: { display: '0.06em', ui: '0.03em', mono: '0em' },
  },
  {
    id: 'cream',
    label: 'Cream',
    description: 'No drama, pure warmth. Linen tablecloth on a Sunday.',
    weight: { display: 400, ui: 400, mono: 400 },
    leading: { display: 1.45, ui: 1.8, mono: 1.65 },
    tracking: { display: '0.03em', ui: '0.03em', mono: '0.01em' },
  },
  {
    id: 'whimsy',
    label: 'Whimsy',
    description: 'Floaty headlines, precise data. Wide-spaced display, crisp mono.',
    weight: { display: 300, ui: 300, mono: 500 },
    leading: { display: 1.35, ui: 1.6, mono: 1.4 },
    tracking: { display: '0.08em', ui: '0.015em', mono: '-0.01em' },
  },
];
